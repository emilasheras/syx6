...
const Post = ({index = 1, animateEntrance = false, onClick, isBrilleEnabled = false}) => {
    ...
    if(!syxutils.empty(asset.extraClasses)) classes += ' ' + asset.extraClasses.join(' ');
    ...
    return (
        <article ref={elementRef} key={index+asset.id} style={style} className={classes} onClick={onClick}>
